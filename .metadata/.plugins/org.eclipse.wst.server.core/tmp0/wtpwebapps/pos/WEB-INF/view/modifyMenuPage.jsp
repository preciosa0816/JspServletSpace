...
<body onload="printTime()">
	...
	<aside id="mode" style="float: right">
		...
		<div id="green">메뉴수정</div>
		<div id="color"><a href=deletemenu.do>메뉴삭제</a></div>
	</aside>
