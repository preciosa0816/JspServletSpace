...
<body onload="printTime()">
	...
	<aside id="mode" style="float: right">
		<div id="color"><a href=list.do>돌아가기</a></div>
		<div id="color"><a href = "add.do" onclick="window.open(this.href,'_blank','width=600,height=400');return false">메뉴추가</a></div>
<!-- 		<div id="color"><a href = "add.do" >메뉴추가</a></div> -->
