...
public class AddMenuHandler implements CommandHandler {//웹요청처리
	private static final String FORM_VIEW="/WEB-INF/view/addMenuForm2.jsp";
	...
	private String processSubmit(HttpServletRequest req, HttpServletResponse res) throws Exception {// 폼 전송 처리
		...
		addreq.setName(req.getParameter("name"));
		addreq.setPrice(Integer.parseInt(req.getParameter("price")));
		addreq.setDrinktype(req.getParameter("drinktype"));
